...
CREATE TABLE `downloader` (
  ...
  `nothing` float NOT NULL,
  `files1` int(11) NOT NULL DEFAULT '0',
  `files2` int(11) NOT NULL DEFAULT '0',
  `files3` int(11) NOT NULL DEFAULT '0'
...
-- Dump completed on 2017-03-12 20:37:04